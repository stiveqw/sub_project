const { festivalKey, festivalTotalSeats, reservedSeats, isReserved } = window.festivalData;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createSeatGrid(totalSeats) {
        ...
        for (let i = 1; i <= totalSeats; i++) {
            ...
            if (reservedSeats && reservedSeats.includes(seatNumber)) {
