...
class Config:
    ...
    COURSE_SERVICE_URL = os.getenv('COURSE_SERVICE_URL', 'http://localhost:5001/course_registration')
    FESTIVAL_SERVICE_URL = os.getenv('FESTIVAL_SERVICE_URL', 'http://localhost:5002/festival')
